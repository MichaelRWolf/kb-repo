...
- stays **Google-native** instead of trying to recreate Confluence inside Drive
- leaves the door open for a future **AI-first knowledge layer**

Current focus: **Confluence → Google Docs** migration.
Evernote and Dropbox files are placeholders for now.
